...
class AvailableHoursScreen extends StatefulWidget {
  final String placeId;

  const AvailableHoursScreen({required this.placeId, Key? key})
      : super(key: key);
...
class _PadelScreenState extends State<AvailableHoursScreen> {
